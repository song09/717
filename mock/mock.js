...
mocker.onPost('/add_new_address').reply(config=>{
    ...
    let ls = localStorage;
    let add_list = {};
    add_list[params.token] = [];
    if(ls.getItem('address-list')){
        add_list = Object.assign({},add_list,JSON.parse(ls.getItem('address-list')));
        // {"13634567618":[{"name":"哈哈哈","phone":"18842489974","province":"北京","city":"北京","area":"通州区","token":"13634567618","id":1},{"name":"急急急","phone":"17623232323","province":"北京","city":"北京","area":"崇文区","token":"13634567618","id":2}]}
