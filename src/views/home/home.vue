<template>
    <div class="homes">
        <header class="header">
            <span><img src="../../images/1_03.png"></span>
            ...
            <div class="main-wrap">
                <div class="swiper-container">
                    <ul class="swiper-wrapper">
                        <li class="swiper-slide"><img src="../../images/pic_1.png"></li>
                        <li class="swiper-slide"><img src="../../images/pic_2.png"></li>
                        <li class="swiper-slide"><img src="../../images/pic_3.png"></li>
                        <li class="swiper-slide"><img src="../../images/pic_4.png"></li>
                    </ul>
                ...
                <div class="icon-lists">
                    <div class="icon-lists-top">
                        <dl>
                            <dt style="background: #47D265"><img src="../../images/swiper1.png"></dt>
                            <dd> 家乡味道</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FF7902"><img src="../../images/swiper2.png"></dt>
                            <dd>进口食品</dd>
                        </dl>
                        <dl>
                            <dt style="background: #5BAAFF"><img src="../../images/swiper3.png"></dt>
                            <dd>牛奶乳品</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FFB447"><img src="../../images/swiper4.png"></dt>
                            <dd>茶果冲引</dd>
                        </dl>
                    </div>
                    <div class="icon-lists-bot">
                        <dl>
                            <dt style="background: #FF655B"><img src="../../images/swiper5.png"></dt>
                            <dd>休闲零食</dd>
                        </dl>
                        <dl>
                            <dt style="background: #67CCFF"><img src="../../images/swiper6.png"></dt>
                            <dd>米面粮油</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FFD33C"><img src="../../images/swiper7.png"></dt>
                            <dd>调味调料</dd>
                        </dl>
                        <dl>
                            <dt style="background: #5BDCC8"><img src="../../images/swiper8.png"></dt>
                            <dd>酒水新料</dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="foodie">
                    <div class="foodie-left"><img src="../../images/home1.png"></div>
                    <div class="foodie-right">
                        <div class="foodie-right-top">

                            <img src="../../images/ruwei.png">
                        </div>
                        <div class="foodie-right-bottom">

                            <img src="../../images/gaodian.png">
                        </div>
                    </div>
                </div>
                ...
                <div class="flavors ks-clear">
                    <good-comp v-for="items in goods_list" :key="items.item_id" :id="items.item_id" :url="items.img2" :name="items.title" :price="items.originalPrice" @tips-active="tips_active"></good-comp>
                </div>
                <div class="loading">
                    {{is_finished}}
                </div>
